...
! function(u) {
    var m = "day",
        ...
        c = {
            init: function(e) {
                var t = u.extend({}, o, e || {});
                t.itemTypes = y.getItemTypesByLayout(t.layout), t._itemsHas = u.extend({}, r);
            ...
            _render: function() {
                ...
                e.data("syotimer-blocks", l).data("syotimer-items", a).addClass("syotimer").append(n).append(o).append(r)
            },
            _perSecondHandler: function() {
                ...
                0 <= r ? (c._refreshUnitsDom.apply(this, [r]), c._applyEffectSwitch.apply(this, [t.effectType])) : (e = u.extend(e, e.data("syotimer-blocks")), t.afterDeadline(e))
            },
            ...
            _applyEffectSwitch: function(e, t) {
                ...
                if ("none" === e) setTimeout(function() {
                    c._perSecondHandler.apply(i, [])
                }, 1e3);
                else if ("opacity" === e) {
                    var o = n.data("syotimer-items")[t];
                    if (o) {
                        var r = l.next(t),
                            a = o.data("syotimer-unit-value");
                        u(".syotimer-cell__value", o).animate({
                            opacity: .1
                        }, 1e3, "linear", function() {
                            c._perSecondHandler.apply(i, [])
                        }), r && 0 === a && c._applyEffectSwitch.apply(i, [e, r])
                    }
                }
            }
        },
        y = {
            ...
            getSecondsToDeadLine: function(e, t) {
                ...
                if (n = Math.floor(n), t.periodic) {
                    var o, r, a = y.getPeriodUnit(t.periodUnit),
                        s = e / (1e3 * a);
                    s = Math.ceil(s), s = Math.abs(s), 0 <= n ? (r = 0 === (r = s % t.periodInterval) ? t.periodInterval : r, r -= 1) : r = t.periodInterval - s % t.periodInterval, 0 == (o = n % a) && n < 0 && r--, i = Math.abs(r * a + o)
                } else i = n;
                return i
            },
            ...
            getDifferenceWithTimezone: function(e, t, i) {
                var n = t.getTime() - e.getTime(),
                    o = 0,
                    r = 0;
                "local" !== i.timeZone && (o = 1e3 * (parseFloat(i.timeZone) * y.getPeriodUnit(a) - -e.getTimezoneOffset() * y.getPeriodUnit(s)));
                i.ignoreTransferTime && (r = 1e3 * (-e.getTimezoneOffset() * y.getPeriodUnit(s) - -t.getTimezoneOffset() * y.getPeriodUnit(s)));
                return n - (o + r)
            },
    ...
    u.fn.syotimer = function(e) {
        ...
        u.error("SyoTimer. Error in call methods: methods is not exist")
    }, u.syotimerLang = {
        rus: {
        ...
        getNumeral: function(e, t, i) {
            var n = this[u.syotimerLang[t].handler || "universal"](e);
            return u.syotimerLang[t][i][n]
        }
    }
}(jQuery);
